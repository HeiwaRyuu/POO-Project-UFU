...
class Ui_Clientes(QWidget):
    ...
    mycursor.execute("CREATE TABLE IF NOT EXISTS clientes (id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT, nome VARCHAR(250), CPF VARCHAR(11), telefone VARCHAR(11), endereco VARCHAR(250))")
